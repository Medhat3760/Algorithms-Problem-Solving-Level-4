namespace _57___Compare_Date_Function
{
    internal class Program
    {
        ...
        {
            //return IstDate1BeforeDate2(date1, date2) ? enDateCompare.Before : (IstDate1EqualDate2(date1, date2) ? enDateCompare.Equal : enDateCompare.After);
