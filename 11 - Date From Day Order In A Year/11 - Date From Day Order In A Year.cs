namespace _11___Date_From_Day_Order_In_A_Year
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            short dayOrderInAYear = NumOfDaysFromBeginningTheYear(year, month, day);


            Console.WriteLine("\nNumber Of Days From The Beginning Of The Year is " + dayOrderInAYear);

            sDate date = GetDateFromDayOrderInAYear(dayOrderInAYear, year);

            Console.WriteLine($"\nDate for [{dayOrderInAYear}] is: {date.day}/{date.month}/{date.year}");
