namespace Project_2_ATM_System
{
    internal class Program
    {
        ...
        public static stClient currentClient;
        ...
        static bool FindClientByAccountNumberAndPinCode(string accountNumber, string pinCode, ref stClient client)
        {
            ...
            List<stClient> lClients = LoadClientsFromFile(clientsFileName);
        ...
        static void SaveClientsListToFile(List<stClient> lClients)
        {
            ...
            if (File.Exists(clientsFileName))
            {
                ...
                using (StreamWriter writer = new StreamWriter(clientsFileName))
                {
            ...
            {
                Console.WriteLine($"\nThe file with name [{clientsFileName}] not found!.");
            }
